...
function aleksandr_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'aleksandr_custom_background_args', array(
...
function aleksandr_scripts() {
	...
	wp_enqueue_script( 'aleksandr-masonry', get_template_directory_uri() . '/js/masonry.pkgd.min.js', array(), '4.0.0x', true );
